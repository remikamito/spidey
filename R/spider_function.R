...
SPIDERZ <- function(input_Zscores, bilateral=TRUE, sigline=TRUE, customtracts=FALSE,
  ...
  # assign tract order
  col_order <- c("SLF III", "SLF II", "SLF I",
                 "ILF", "IFOF", "UF", "AF",
                 "FX", "CG",
                 "SCP", "CST")
